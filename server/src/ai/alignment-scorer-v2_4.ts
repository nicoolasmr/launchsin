...
export class AlignmentScorerV2_4 {
    ...
    /**
     * Main scoring function: Heuristics + LLM with fallback
     */
    async score(input: ScoringInput, adId: string = 'unknown'): Promise<ScoringResult> {
        ...
        const redactedPageText = this.redactText(input.pageSnapshot.contentText.substring(0, 2000)); // Max 2k chars
        ...
        try {
            ...
            // Merge LLM signals (prioritize high impact)
    ...
    /**
     * Heuristics-based scoring (always runs)
     */
    private runHeuristics(input: ScoringInput): {
        ...
        // Check offer keywords (simple heuristic)
    ...
    /**
     * LLM-based scoring (with timeout and error handling)
     */
...
Return ONLY valid JSON in this format:
{
  "signals": [
    ...
    private buildGoldenRule(
        ...
        // Prioritize and limit to top 5 signals
    ...
    /**
     * Generate next actions from signals
     */
    ...
    redactText(text: string): string {
        ...
        // Remove potential IDs (long alphanumeric strings)
...
export const alignmentScorerV2_4 = new AlignmentScorerV2_4();
