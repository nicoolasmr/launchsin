...
export function SchedulesTab({ projectId }: { projectId: string }) {
    ...
    return (
        <div className="space-y-6">
            ...
            {editingSchedule && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" onClick={() => setEditingSchedule(null)}>
                    <Card className="p-6 max-w-md w-full mx-4" onClick={(e: React.MouseEvent) => e.stopPropagation()}>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    max={1000}
                                    value={editBudget}
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEditBudget(Number(e.target.value))}
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <select 
                                    ...
                                    value={editCadence}
                                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setEditCadence(e.target.value as 'daily' | 'weekly')}
                                >
                            ...
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    id="edit-enabled"
                                    checked={editEnabled}
                                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEditEnabled(e.target.checked)}
                                />
